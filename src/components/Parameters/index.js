...
const Parameters = (props) => {
    ...
    const onChangeMediaType = ({value, pathMethod}) => {
        ...
        const shouldRetainRequestBodyVal = shouldRetainRequestBodyValue(...pathMethod);
            ...
            <div className="opblock-section-header">
                {isOAS3() ? (
                    <div className="tab-header">
                        <div onClick={() => toggleTab("parameters")}
                             className={`tab-item ${parametersVisible && "active"}`}>
                            <h4 className="opblock-title"><span>Parameters</span></h4>
                        </div>
                        {operation.get("callbacks") ?
                            (
                                <div onClick={() => toggleTab("callbacks")}
                ...
                {allowTryItOut ? (
                    <TryItOutButton
                        ...
                        onResetClick={() => setRequestBodyValue({value: undefined, pathMethod})}/>
                ) : null}
            </div>
                            ...
                            <tbody>
                            {
                                groupedParametersArr.map((parameter, i) => {
                                    ...
                                    <ParameterRow
                                        ...
                                        rawParam={parameter}
                                        param={parameterWithMetaByIdentity(pathMethod, parameter)}
