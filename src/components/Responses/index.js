...
const Responses = (props) => {
    ...
    const onChangeProducesWrapper = (val) => specActions.changeProducesValue([path, method], val)
    ...
    return responses !== undefined && responses?.entrySeq() && responses?.entrySeq()?.size > 0 ?
                    ...
                    <table aria-live="polite" className="responses-table" id={regionId} role="region">
                        ...
                        <tr className="responses-header">
                            ...
                            {specSelectors.isOAS3() ?
                                <td className="col col_header response-col_links">Links</td> : null}
                        </tr>
                        </thead>
                        <tbody>
                        {
