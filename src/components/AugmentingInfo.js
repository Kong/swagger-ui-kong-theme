...
const EyeSVG = () =>
    <svg width="16px" height="9px" viewBox="0 0 16 9" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <g id="Portal" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="15.00.-I-find-the-API’s-acmePortalsOne-portal,-and-navigate-to-it.-I-see-that-fooAPI-has-2-versions,-one-that-I-can-register-to-(v1.0)-and-one-that-I-can-not.-I-can-browse-the-spec-documentation-for-both"
               transform="translate(-1288.000000, -250.000000)" fill="#808080">
...
const Contact = (props) => {
    ...
    return (
        <div>
            {url && <div>
                <a href={sanitizeUrl(url)} target="_blank">{name} - Website</a>
            </div>}
...
const Info = (props) => {
    ...
    return (
        <div className="info">
            ...
            {externalDocsUrl ?
                <a target="_blank"
                   href={sanitizeUrl(externalDocsUrl)}>{externalDocsDescription || externalDocsUrl}</a>
                : null}
